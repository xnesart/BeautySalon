...
public class ServicesHandler
{
    ...
    public async void ChoseMakeUp(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
    {
        ...
        await botClient.SendTextMessageAsync(update.CallbackQuery.Message.Chat.Id, "В нашем салоне доступны следующие виды макияжа:",
            replyMarkup: inlineKeyboard);
    }
    ...
    public async void ChoseStyling(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
    {
        ...
        await botClient.SendTextMessageAsync(update.CallbackQuery.Message.Chat.Id, "В нашем салоне доступны следующие виды моделирования волос:",
            replyMarkup: inlineKeyboard);
    }
}